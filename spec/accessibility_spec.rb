...
# In most places WCAG 2.1 AA is the minimum requirement, but 2.2 is the current WCAG Standard.
...
# It should be rare to add to this array. One acceptable use is to add
# redirect pages, because they can introduce race conditions and make the
# a11y tests fail inconsistently.
SKIPPED_PAGES = [
  '/calendar/',
  '/oh/',
  '/book/',
...
# We must call this to ensure the build is up-to-date.
build_jekyll_site!
